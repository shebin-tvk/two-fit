      ...
      <div className=' grid grid-cols-1 place-items-center gap-0 md:gap-5  md:grid-cols-3 px-[5px] md:px-5 lg:px-[150px] '>
        {designData.map((item, i) => (
          <div key={i} className='group md:hover:h-auto md:group-hover:flex md:group-hover:flex-col w-full bg-red900'>
            ...
            <div className='flex md:group-hover:block md:group-hover:h-auto flex-col gap-4 md:hidden  bg-[#0A4F48] rounded-2xl w-full  my-2 py-5 px-5  md:py-2 md:px-2 lg:py-4 lg:px-4 text-white'>
              <p className='md:text-md text-xl'>Duration</p>
              <div className='flex flex-row justify-between  md:text-xs lg:text-lg'>
                <button className='rounded-2xl border px-10 py-2 md:text-xs md:text-md lg-text-lg md:py-1 lg:py-2 md:px-1 lg:px-2  bg-[#10635b]'>30 Days</button>
                <button className='rounded-2xl border px-10 py-2 md:text-xs md:text-md lg-text-lg md:py-1 lg:py-2 md:px-1 lg:px-2  bg-[#10635b]'>60 Days</button>
                <button className='rounded-2xl border px-10 py-2 md:text-xs md:text-md lg-text-lg md:py-1 lg:py-2 md:px-1 lg:px-2  bg-[#10635b]'>90 Days</button>
              </div>
            </div>
